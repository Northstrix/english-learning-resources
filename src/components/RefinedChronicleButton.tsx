...
const RefinedChronicleButton = React.forwardRef<HTMLButtonElement, RefinedChronicleButtonProps>(
  (
    ...
    useEffect(() => {
      ...
      if (!el) return;
      applyBaseStyle(el);
    }, [disabled, buttonRef, backgroundColor, textColor, borderColor, borderRadius]);
    ...
    return (
      <>
        ...
        <style jsx>{`
          ...
          .flip-wrapper .side-front em {
            transform-origin: top;
            opacity: 1;
            transform: rotateX(0deg);
          }
          .flip-wrapper .side-back em {
            opacity: 0;
            transform: rotateX(-90deg) scaleX(0.9) translate3d(0, 10px, 0);
            transform-origin: bottom;
          }
          .RefinedchronicleButton:not(:disabled):hover .flip-wrapper .side-front em {
            opacity: 0;
            transform: rotateX(90deg) scaleX(0.9) translate3d(0, -10px, 0);
          }
          .RefinedchronicleButton:not(:disabled):hover .flip-wrapper .side-back em {
            opacity: 1;
